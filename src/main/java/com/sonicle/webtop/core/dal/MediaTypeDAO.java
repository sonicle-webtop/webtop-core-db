 ...
 * @author malbinola
 */
public class MediaTypeDAO extends BaseDAO {
	
	private final static MediaTypeDAO INSTANCE = new MediaTypeDAO();
	public static MediaTypeDAO getInstance() {
		return INSTANCE;
	}
	
	public List<OMediaType> selectAll(Connection con) throws DAOException {
